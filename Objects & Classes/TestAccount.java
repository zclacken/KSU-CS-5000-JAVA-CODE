...
public class TestAccount
{
    public static void main(String[] args)
    {
        ...
        while(rerun.equalsIgnoreCase("y"))
        {
            ...
            System.out.println("\nInitial myAccount Information:");
            System.out.println("ID: " + myAccount.getId());
            System.out.println("Balance: " +
                    money.format(myAccount.getBalance()));
            System.out.println("Annual Interest Rate: " +
                    percent.format(myAccount.getAnnualInterestRate()));

            // deposit test for my account
            System.out.print("\nEnter deposit amount for myAccount: ");
            ...
            System.out.print("\nEnter withdrawal amount for myAccount: ");
            ...
            System.out.println("\nInterest Information for myAccount:");
            System.out.println("Monthly Interest Rate: " +
                    percent.format(myAccount.getMonthlyInterestRate()));
            ...
            System.out.print("\nEnter withdrawal amount for yourAccount: ");
            ...
            System.out.println("\nMonthly Interest Rate:\t" +
                    percent.format(yourAccount.getMonthlyInterestRate()));
